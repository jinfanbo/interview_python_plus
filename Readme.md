...
a = 1
def fun(a):
    print("func_in",id(a))   # func_in 1442868240
    a = 2
    print("re-point",id(a), id(2))   # re-point 1442868272 1442868272
print("func_out",id(a), id(1))  # func_out 1442868240 1442868240
fun(a)
print(a)  # 1
```
...
a = []
def fun(a):
    print("func_in",id(a))  # func_in 1674625960520
    a.append(1)
print("func_out",id(a))     # func_out 1674625960520
fun(a)
print(a)  # [1]
```
...
#   File "E:/python代码/test.py", line 7, in <module>
#     print(mc.__superprivate)
...
#初始化
#初始化
#<__main__.Person object at 0x000001879AA75240> <__main__.Person object at 0x000001879AA75240>
print(p1.name)   #李四
print(p2.name)   #李四
```
...
详细见: https://blog.csdn.net/qzcsu/article/details/72861891
